...
function CheckCircleIntersection(point1, point2) {
    ...
    if (d > r1 + r2) {
        ...
        // วาดเส้นระหว่างจุดที่ใกล้กันที่สุดของวงกลมทั้งสอง
    ...
    // หากวงกลมตัดกัน (กรณีปกติที่วงกลมสองวงตัดกัน)
...
function DrawLine(x1, y1, x2, y2) {
    ...
    ctx.moveTo(x1, y1);
    ctx.lineTo(x2, y2);
    ctx.strokeStyle = 'rgba(255, 0, 0, 0.5)';  // กำหนดสีเส้นเป็นสีแดงโปร่งแสง
    ctx.stroke();
